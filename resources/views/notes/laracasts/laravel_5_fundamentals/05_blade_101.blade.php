...
<div class="col-md-9 col-md-push-3">
  ...
  <section><!-- infomations  -->
    ...
    <hr>
    <ol>
      <li><a href="#introduction">laravel视频教程《Blade视图模板基础》简介</a></li>
      <li><a href="#note">laravel视频教程《Blade视图模板基础》笔记</a></li>
      <li><a href="#link">laravel视频教程《Blade视图模板基础》地址</a></li>
    </ol>

    <h3 id="introduction">laravel视频教程《Blade视图模板基础》简介</h3>
    <p>正式开始。</p>
  </section>

  <section><!-- main content  -->
    <h3 id="note">laravel视频教程《Blade视图模板基础》笔记</h3>
    <p>英文渣催更请戳微信：larapad 或 QQ 群：575709105，反馈多的视频优先更新！欢迎字幕君联系！</p>
  </section>

  <section>
    <h3 id="link">laravel视频教程《Blade视图模板基础》下载地址</h3>
    <p>
      百度云盘链接：
