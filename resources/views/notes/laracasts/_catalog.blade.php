...
<a href="/laracasts" alt="Laracasts 官网网站" target="_blank">点击访问>> Laracasts 官网</a>

<hr>

<div>
  <h3>【单个课程】<small>点击访问>>单个课程列表</small></h3>

  <hr>
</div>

<div>
  <h3>【系列课程】<small>按字母顺序排列</small></h3>
  <div>
    <!-- Nav tabs -->
    ...
    <div class="tab-content">
      <div role="tabpanel" class="tab-pane active" id="first_tab">
        @include('notes.laracasts._catalog_1')
      </div>
    </div>
  </div>
</div>
